...
Phoibos システムの（非ベーク時における）
* Sample 温度 (Lakeshore GPIB)
* Pressure  (measured by ion gauge)
* Pressure  (measured by ion pump)
* High voltage (applied SCR, Channel plate, measured in limitation box)
などのモニタ。
