...
listener = serial.Serial(
    port=PORT1, baudrate=BAUD_RATE, timeout=READ_TIMEOUT, write_timeout=WRITE_TIMEOUT
)
forwarder = serial.Serial(
    port=PORT2, baudrate=BAUD_RATE, timeout=READ_TIMEOUT, write_timeout=WRITE_TIMEOUT
)
